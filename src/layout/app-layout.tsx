...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['travel-planner', 'administrator', 'group-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Expenses', path: '/expenses', entity: 'expense', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
